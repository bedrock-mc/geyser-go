...
func projectJavaMobSpawner(tag map[string]any) {
	// Geyser's SpawnerBlockEntityTranslator marks the block actor movable even
	// when the Java payload is absent or semantically incomplete.
	tag["isMovable"] = byte(1)
