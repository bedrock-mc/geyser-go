// Code generated from the pinned Geyser mappings biome table; DO NOT EDIT.
// Source repository: https://github.com/GeyserMC/mappings
// Source commit: 5d38942
// Source SHA-256: fea91ede43717c5aebd565f9291668e05702ca5f1018c9e6ead517cb590673a4

package data

// Java1214BiomeToBedrock contains the Bedrock network biome IDs accepted by
// the 1.26.30 client for Java 1.21.4 biome identifiers. Java registry IDs are
// resolved through this name table when the configuration registry is read.
var Java1214BiomeToBedrock = map[string]int32{
...
func Java1214BiomeRuntimeID(name string) (int32, bool) {
	id, ok := Java1214BiomeToBedrock[name]
	return id, ok
}
